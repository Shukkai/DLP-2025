...
class DecoderBlock(nn.Module):
    """
    Decoder block that upsamples and concatenates the skip connection, then applies convolutions.
    """
...
class ResNet34_UNet(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.encoder3 = EncoderBlock(64, 128, n_blocks=4)     # skip from encoder3: 64 channels (input to block)
